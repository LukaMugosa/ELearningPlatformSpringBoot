...
/**
 * Criteria class for the {@link me.amplitudo.elearning.domain.Orientation} entity. This class is used
 * in {@link me.amplitudo.elearning.web.rest.OrientationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /orientations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class OrientationCriteria implements Serializable, Criteria {
    ...
    public OrientationCriteria() {
    }

    public OrientationCriteria(OrientationCriteria other) {
    ...
    @Override
    public OrientationCriteria copy() {
        return new OrientationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrientationCriteria that = (OrientationCriteria) o;
        return
